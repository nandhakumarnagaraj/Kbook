...
val releaseVersionCode = configValue("RELEASE_VERSION_CODE", "15").toIntOrNull() ?: 15
val releaseVersionName = configValue("RELEASE_VERSION_NAME", "1.0.8")
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "WEB_ADMIN_URL", "\"$webAdminUrl\"")
