...
import com.khanabook.lite.pos.core.theme.ParchmentBG
        ...
        Card(
            ...
            Column(modifier = Modifier.fillMaxWidth().padding(KhanaBookTheme.spacing.medium)) {
                ...
                if (errorMessage != null) {
                    androidx.compose.foundation.layout.Spacer(modifier = Modifier.height(com.khanabook.lite.pos.core.theme.KhanaBookTheme.spacing.small))
                    Text(
                        text = errorMessage,
                        color = ErrorPink,
                        style = MaterialTheme.typography.bodyMedium
...
internal fun PermissionDeniedContent(onRequestPermission: () -> Unit) {
    ...
    Column(
        ...
        Spacer(modifier = Modifier.height(com.khanabook.lite.pos.core.theme.KhanaBookTheme.spacing.medium))
        Button(
