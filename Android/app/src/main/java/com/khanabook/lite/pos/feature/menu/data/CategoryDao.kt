...
interface CategoryDao {
    ...
    suspend fun getAllCategoryServerIds(restaurantId: Long): List<com.khanabook.lite.pos.feature.sync.domain.ServerIdMapping>
    ...
    suspend fun getUnsyncedCategories(restaurantId: Long): List<com.khanabook.lite.pos.feature.menu.data.CategoryEntity>
    ...
    @Insert(onConflict = OnConflictStrategy.ABORT)
    suspend fun insertSyncedCategories(items: List<com.khanabook.lite.pos.feature.menu.data.CategoryEntity>)
    ...
    suspend fun findCategoryByServerId(serverId: Long, restaurantId: Long): com.khanabook.lite.pos.feature.menu.data.CategoryEntity?
}
