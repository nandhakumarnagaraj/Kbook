...
import com.khanabook.lite.pos.feature.payments.data.CreateEasebuzzPaymentLinkRequest
import com.khanabook.lite.pos.feature.payments.data.EasebuzzRefundRequest
    ...
    suspend fun createPaymentLinkForBill(
        ...
        runApi {
            api.createPaymentLinkForBill(
                com.khanabook.lite.pos.feature.payments.data.CreatePaymentLinkForBillRequest(
                    billId = billId,
                    restaurantId = restaurantId,
                    customerPhone = customerPhone,
                    customerEmail = customerEmail
