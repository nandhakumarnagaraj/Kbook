...
class KhanaBookFirebaseMessagingService : FirebaseMessagingService() {
    ...
    @Inject
    lateinit var notificationRepository: com.khanabook.lite.pos.feature.notifications.data.NotificationRepository

    @Inject
    lateinit var syncManager: com.khanabook.lite.pos.feature.sync.domain.SyncManager
