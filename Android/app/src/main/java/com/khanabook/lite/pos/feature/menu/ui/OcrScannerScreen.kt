...
fun OcrScannerScreen(
    ...
    viewModel: com.khanabook.lite.pos.feature.menu.viewmodel.MenuViewModel,
    onBack: () -> Unit,
        ...
        rememberLauncherForActivityResult(ActivityResultContracts.PickVisualMedia()) { uri ->
            uri?.let {
                ...
                try {
                    ...
                    errorMessage = com.khanabook.lite.pos.core.util.UserMessageSanitizer.sanitize(t, "Failed to load image. Please try again.")
                }
            }
        }
