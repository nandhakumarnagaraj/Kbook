...
import com.khanabook.lite.pos.feature.payments.data.*
...
interface KhanaBookApi {
        ...
        suspend fun lookupFssai(@Query("fssaiNo") fssaiNo: String): com.khanabook.lite.pos.feature.payments.data.FssaiLookupResponse
        ...
        suspend fun createPaymentLinkForBill(
            @Body request: com.khanabook.lite.pos.feature.payments.data.CreatePaymentLinkForBillRequest
        ): Map<String, Any?>
        ...
        suspend fun onboardEasebuzz(
            @Body request: com.khanabook.lite.pos.feature.payments.data.EasebuzzOnboardingRequest
        ): com.khanabook.lite.pos.feature.payments.data.EasebuzzOnboardingResponse
        ...
        suspend fun generateKycAccessKey(): com.khanabook.lite.pos.feature.payments.data.EasebuzzKycAccessKeyResponse

        @POST("api/v1/restaurants/payment-config/easebuzz/verify-otp")
        suspend fun verifyEasebuzzOtp(
            @Body request: com.khanabook.lite.pos.feature.payments.data.EasebuzzOtpRequest
        ): Map<String, Any?>
