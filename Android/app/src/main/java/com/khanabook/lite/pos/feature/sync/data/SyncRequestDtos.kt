...
data class BillSyncDto(
    ...
    @SerializedName("createdTerminalId") val createdTerminalId: String? = null,
    @SerializedName("createdDeviceId") val createdDeviceId: String? = null,
    @SerializedName("currentOwnerTerminalId") val currentOwnerTerminalId: String? = null,
    ...
    @SerializedName("statusVersion") val statusVersion: Int,
...
data class RestaurantProfileSyncDto(
    ...
    // Printer bindings are device-local and deliberately not part of the sync payload.
    // See PrinterProfileEntity / printer_profiles.
    ...
    @SerializedName("collectCustomerNumber") val collectCustomerNumber: Boolean,
    @SerializedName("updatedAt") val updatedAt: Long,
    @SerializedName("isDeleted") val isDeleted: Boolean,
    @SerializedName("serverUpdatedAt") val serverUpdatedAt: Long,
