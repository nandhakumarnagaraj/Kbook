package com.khanabook.lite.pos.feature.sync.worker
...
import com.khanabook.lite.pos.feature.sync.domain.SyncWorkNames
    ...
    syncManager.performFullSync().fold(
        ...
        onFailure = { e ->
          ...
          if (e is SyncConflictException) {
            ...
            logWarn("Conflict recovery pull did not complete — keeping WorkManager retries active")
            return@withContext Result.retry()
          }
