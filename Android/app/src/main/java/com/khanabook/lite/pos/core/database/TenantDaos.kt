...
import com.khanabook.lite.pos.feature.reports.domain.TopSellingItem
...
class TenantMenuDao @Inject constructor(
    ...
    override suspend fun getAllMenuItemImageInfo(restaurantId: Long): List<com.khanabook.lite.pos.feature.sync.domain.MenuItemImageInfo> = dao.getAllMenuItemImageInfo(restaurantId)
...
class TenantBillDao @Inject constructor(
    ...
    override suspend fun finalizeOnlineBillAtomically(
        ...
        completedAt: Long
    ): com.khanabook.lite.pos.feature.billing.data.BillFinalizationResult = dao.finalizeOnlineBillAtomically(
        billId,
        restaurantId,
        terminalId,
        requestedPayments,
    ...
    override suspend fun recoverPartialPaymentAndFinalizeAtomically(
        ...
        completedAt: Long
    ): com.khanabook.lite.pos.feature.billing.data.BillFinalizationResult =
...
class TenantNotificationDao @Inject constructor(
    ...
    override suspend fun getReadIds(ids: List<Long>): List<Long> = dao.getReadIds(ids)
