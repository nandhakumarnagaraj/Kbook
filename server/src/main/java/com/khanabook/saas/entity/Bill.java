...
@Table(name = "bills", uniqueConstraints = {
		@UniqueConstraint(name = "bills_restaurant_id_device_id_local_id_key", columnNames = {
...
public class Bill extends BaseSyncEntity {
	...
	@Column(name = "public_token", nullable = false, unique = true, columnDefinition = "UUID DEFAULT gen_random_uuid()")
