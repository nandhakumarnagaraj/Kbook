...
public class BillItemServiceImpl implements BillItemService {
	...
	@Override
	@Transactional(readOnly = true)
	public org.springframework.data.domain.Page<BillItem> pullData(Long tenantId, Long lastSyncTimestamp, String deviceId, boolean ignoreDeviceId, org.springframework.data.domain.Pageable pageable) {
		if (ignoreDeviceId) {
