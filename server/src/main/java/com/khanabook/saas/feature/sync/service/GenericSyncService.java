...
import com.khanabook.saas.feature.billing.util.BillTerminalUtil;
...
public class GenericSyncService {
	...
	private com.khanabook.saas.feature.inventory.service.InventoryService inventoryService;
		...
		for (Map.Entry<String, List<T>> entry : recordsByDevice.entrySet()) {
			...
			for (T incomingRecord : devicePayload) {
				try {
					...
					var validationResult = com.khanabook.saas.feature.sync.validation.SyncPayloadValidator.validate(incomingRecord);
					...
					if (incomingRecord instanceof Bill bill
							&& repository instanceof com.khanabook.saas.feature.billing.data.BillRepository billRepo) {
					...
					if (incomingRecord instanceof Bill incomingBill
							...
							&& repository instanceof com.khanabook.saas.feature.billing.data.BillRepository billRepo2) {
