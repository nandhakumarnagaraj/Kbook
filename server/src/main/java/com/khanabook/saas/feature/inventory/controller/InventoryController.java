...
public class InventoryController {
    ...
    private final com.khanabook.saas.feature.inventory.data.PurchaseOrderRepository purchaseOrderRepository;
    ...
    public InventoryController(RawMaterialRepository rawMaterialRepository,
                               ...
                               com.khanabook.saas.feature.inventory.data.PurchaseOrderRepository purchaseOrderRepository,
    ...
    public ResponseEntity<?> createVendor(@RequestBody Map<String, Object> body) {
        ...
        com.khanabook.saas.feature.inventory.data.Vendor v = new com.khanabook.saas.feature.inventory.data.Vendor();
    ...
    public ResponseEntity<?> createPurchaseOrder(@RequestBody Map<String, Object> body) {
        ...
        try {
            ...
            List<com.khanabook.saas.feature.inventory.data.PurchaseOrderDtos.PoLine> lines = new java.util.ArrayList<>();
            if (rawLines != null) {
                for (Map<String, Object> l : rawLines) {
                    lines.add(new com.khanabook.saas.feature.inventory.data.PurchaseOrderDtos.PoLine(
