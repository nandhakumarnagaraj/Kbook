package com.khanabook.saas.feature.payments.controller;
...
public class AdminSubMerchantController {
    ...
    private final com.khanabook.saas.feature.payments.service.EasebuzzReconciliationService reconciliationService;
