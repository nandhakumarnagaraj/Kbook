...
public class TerminalOwnershipService {
    ...
    private Long resolveParentBillId(BaseSyncEntity record) {
        if (record instanceof com.khanabook.saas.feature.billing.data.BillItem bi) {
            return bi.getServerBillId();
        } else if (record instanceof com.khanabook.saas.feature.billing.data.BillPayment bp) {
