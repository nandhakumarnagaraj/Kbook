...
public class EasebuzzHashService {
    ...
    public String buildTransactionStatusHash(
            String key,
            String txnId,
            String amount,
            String email,
        ...
        String raw = String.join("|", key, txnId, amount, email, phone, salt);
        return sha512(raw);
    }
    ...
    public String buildRefundWebhookHash(
            String salt,
            String status,
            String refundId,
            String amount,
        ...
        String raw = salt + "|" + status + "|" + refundId + "|" + amount + "|"
                + merchantRefundId + "|" + easepayId + "|" + key;
        return sha512(raw);
    }

    public String buildSubMerchantCreateHash(
            String key,
            String businessName,
            String contactEmail,
            String contactPhone,
        ...
        return sha512(String.join("|", key, businessName, contactEmail, contactPhone, salt));
    }

    public String buildSubMerchantUpdateHash(
            String key,
        ...
        return sha512(String.join("|", key, subMerchantId, contactEmail, contactPhone, salt));
    }

    public String buildSubMerchantKycAccessHash(
            String key,
            String subMerchantId,
            String salt
    ) {
        return sha512(String.join("|", key, subMerchantId, salt));
    }
