...
import com.khanabook.saas.common.JwtUtility;
import com.khanabook.saas.auth.domain.User;
import com.khanabook.saas.auth.repository.UserRepository;
import com.khanabook.saas.auth.repository.TokenBlocklistRepository;
import com.khanabook.saas.auth.service.UserLookupService;
			...
			try {
				if (!jwtUtility.isTokenExpired(jwt)) {
					...
					if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
						...
						User user = userLookupService.findByAnyIdentifier(username);
